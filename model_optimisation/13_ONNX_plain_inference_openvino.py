...
log_filename = os.path.join(RESULTS_FOLDER, f'{formatted_now}_onnx_inference_openvino.log')
logging.basicConfig(
    level=logging.INFO,
...
session = ort.InferenceSession("models/mnist_cnn.onnx", provider=['OpenVINOExecutionProvider'])
